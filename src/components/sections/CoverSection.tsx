...
export default function CoverSection() {
  ...
  const heartAnimation = useScrollAnimation({ threshold: 0.3, animationDelay: 300 })
                ...
                <g clipPath="url(#lottie_clip_path)">
                  <g transform="matrix(1,0,0,1,80,23)" opacity="1" style={{display: "block"}}>
                    <path
                      ...
                      style={{
                        strokeDasharray: 800,
                        strokeDashoffset: heartAnimation.shouldAnimate ? 0 : 800,
                        transition: 'stroke-dashoffset 4s ease-out'
                      }}
                      className={heartAnimation.shouldAnimate ? 'animate-heart-beat-scroll' : ''}
                    />
                  </g>
                </g>
              </svg>
